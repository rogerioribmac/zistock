    ...
    return {
        ...
        onSelectionChanged: function (oEvent) {
            ...
            for (let i=0; i<oSegments.length; i++){
                aStorLocation.push({ operator :"EQ", validated: "NotValidated", values: [oSegments[i].getProperty("displayedValue")]});
            }

            var oTable = this.byId("com.ep.zistocks::zz_pv_stock_zite_itecObjectPage--fe::table::_assets::LineItem");
            if (oTable){
